...
build -a ${ARCH} -t ${COMPILER} -b ${DEBUG} -p ArmVirtPkg/ArmVirtQemu.dsc --pcd gEfiMdeModulePkgTokenSpaceGuid.PcdFirmwareVendor=L"Ajay Aarch64 Qemu" --pcd gEfiMdeModulePkgTokenSpaceGuid.PcdFirmwareVersionString=L"Ajay Aarch64 Qemu v1" ${BUILD_FLAGS}
